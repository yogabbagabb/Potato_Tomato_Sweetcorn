...
def calculateR2Python(csvFiles):
    for aFile in csvFiles:
        ...
        # Get or Set the column names from the data frame under which the predicted model
        # yield estimate are stored.
...
if __name__ == "__main__":
    calculateR2Python(["yan_combinations_sweetcorn.csv"])
